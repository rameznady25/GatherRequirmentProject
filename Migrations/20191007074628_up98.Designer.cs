...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gather_Requirement_Project.Models.MainPortal", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Gather_Requirement_Project.Models.Portal", b =>
                {
                    ...
                    b.Property<int?>("MainPortalID");

                    b.HasKey("ID");

                    b.HasIndex("MainPortalID");
            ...
            modelBuilder.Entity("Gather_Requirement_Project.Models.Section", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Gather_Requirement_Project.Models.CustomerProgram", b =>
                {
                    ...
                    b.HasOne("Gather_Requirement_Project.Models.Section")
            ...
            modelBuilder.Entity("Gather_Requirement_Project.Models.Portal", b =>
                {
                    b.HasOne("Gather_Requirement_Project.Models.MainPortal", "MainPortal")
                        .WithMany("Portals")
                        .HasForeignKey("MainPortalID");
                });
